...
import 'package:grocery_flutter/pages/social/social_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: switch (currentIndex) {
        0 => const GroceryListsPage(title: 'Grocery lists'),
        1 => const RecipesPage(title: 'Recipes'),
        2 => const SocialPage(title: 'Social'),
        _ => const Align(
